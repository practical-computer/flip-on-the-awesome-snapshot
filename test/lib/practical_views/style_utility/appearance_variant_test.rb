...
class PracticalViews::WebAwesome::StyleUtility::AppearanceVariantTest < ActiveSupport::TestCase
  def assert_variants(expected:, variants:)
    assert_equal expected, PracticalViews::WebAwesome::StyleUtility::AppearanceVariant.css(variants: variants)
  end
