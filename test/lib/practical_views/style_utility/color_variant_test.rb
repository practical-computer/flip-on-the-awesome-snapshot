...
class PracticalViews::WebAwesome::StyleUtility::ColorVariantTest < ActiveSupport::TestCase
  def assert_variant(expected:, variant:)
    assert_equal expected, PracticalViews::WebAwesome::StyleUtility::ColorVariant.css(variant: variant)
  end
