...
class PracticalViews::WebAwesome::StyleUtility::SizeVariantTest < ActiveSupport::TestCase
  def assert_size(expected:, size:)
    assert_equal expected, PracticalViews::WebAwesome::StyleUtility::Size.css(size: size)
  end
