...
class User::EmergencyPasskeyRegistrationMailerTest < ActionMailer::TestCase
  ...
  test "emergency_registration_request" do
    ...
    Timecop.freeze(Time.now.utc) do
      mail = User::EmergencyPasskeyRegistrationMailer.emergency_registration_request(emergency_passkey_registration: emergency_registration)

      assert_equal "Postmark Template: \"emergency-passkey-registration\"", mail.subject
      assert_equal [emergency_registration.user.email], mail.to
      ...
      assert_equal emergency_registration.user.name, template_model["name"]
      assert_equal user_emergency_passkey_registration_url(token), template_model["action_url"]
