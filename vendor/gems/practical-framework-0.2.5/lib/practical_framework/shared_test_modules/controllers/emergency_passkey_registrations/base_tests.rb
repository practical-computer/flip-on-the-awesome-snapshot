...
module PracticalFramework::SharedTestModules::Controllers::EmergencyPasskeyRegistrations::BaseTests
  ...
  included do
    ...
    test "use: returns a bad_request with the PracticalFramework error JSON if the passkey label is missing" do
      emergency_passkey_registration = valid_emergency_registration
      assert_nil emergency_passkey_registration.used_at
      ...
      assert_form_error_for_label(message: "can't be blank")
    end

    test "use: returns a bad_request with the PracticalFramework error JSON if the passkey challenge fails" do
      emergency_passkey_registration = valid_emergency_registration
      assert_nil emergency_passkey_registration.used_at
    ...
    test "use: returns a bad_request with the PracticalFramework error JSON if the credential was missing" do
      emergency_passkey_registration = valid_emergency_registration
      assert_nil emergency_passkey_registration.used_at
    ...
    test "use: returns a bad_request with the PracticalFramework error JSON if the credential could not be parsed" do
      emergency_passkey_registration = valid_emergency_registration
      assert_nil emergency_passkey_registration.used_at
