...
module PracticalFramework::SharedTestModules::Controllers::ResourceUsingDevisePasskeys::BaseTests
  ...
  included do
    ...
    test "create returns an error if the passkey_label is a duplicate" do
      ...
      assert_response :bad_request
      assert_form_error_for_label(message: "has already been taken")
    end
    ...
    test "destroy does not delete a passkey for another user" do
      sign_in_as_resource
