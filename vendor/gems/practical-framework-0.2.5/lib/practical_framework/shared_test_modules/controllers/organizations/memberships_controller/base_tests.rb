...
module PracticalFramework::SharedTestModules::Controllers::Organizations::MembershipsController::BaseTests
  ...
  included do
    test "index: lists all non-archived-by_user membership types and membership invitations" do
      ...
      self_archived_user = users.retired_department_head
      self_archived_user.memberships.update!(state: :archived_by_user)

      active_membership_user = users.organization_1_department_head
      pending_reacceptance_user = users.moonlighter
    ...
    test "edit: renders the form" do
      ...
      membership = users.organization_1_department_head.memberships.find_by!(organization: organization)
    ...
    test "update: can archive a pending_reacceptance membership" do
      ...
      membership = users.apprentice.memberships.find_by!(organization: organization)
    ...
    test "update: can unarchive an archived_by_organization membership" do
      ...
      membership = users.retired_department_head.memberships.find_by!(organization: organization)
