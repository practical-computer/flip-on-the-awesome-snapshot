...
class Organizations::MembershipsController < Organizations::BaseController
  ...
  breadcrumb :organization_memberships, :organization_memberships_path, match: :exact
  ...
  def edit
    breadcrumb :edit_organization_membership, edit_organization_membership_path(current_organization, @membership)
