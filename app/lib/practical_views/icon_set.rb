...
class PracticalViews::IconSet
  ...
  define_icons(icon_definitions: [
    ...
    IconDefinition.new(method_name: :passkey_icon, icon_name: :passkey, preset: :kit),
    IconDefinition.new(method_name: :add_note_icon, icon_name: :"solid-note-circle-plus", preset: :kit),
    IconDefinition.new(method_name: :edit_note_icon, icon_name: :"solid-note-pen", preset: :kit),
    IconDefinition.new(method_name: :delete_note_icon, icon_name: :"solid-note-slash", preset: :kit),
    IconDefinition.new(method_name: :archive_membership_icon, icon_name: :"solid-id-badge-slash", preset: :kit),
    IconDefinition.new(method_name: :accepted_membership_invitation_icon, icon_name: :"solid-warehouse-circle-check", preset: :kit),
    IconDefinition.new(method_name: :destroy_membership_invitation_icon, icon_name: :"solid-warehouse-slash", preset: :kit),
