...
class PracticalViews::Datatable::SortLinkComponent < PracticalViews::BaseComponent
  ...
  def icon
    case sort_direction
    when "desc"
      return helpers.icon_set.descending_icon
    when "asc"
      return helpers.icon_set.ascending_icon
    else
      return helpers.icon_set.sort_icon
    end
  end
