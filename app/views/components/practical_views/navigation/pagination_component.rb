...
class PracticalViews::Navigation::PaginationComponent < ApplicationComponent
  ...
  def previous_item
    ...
    text = helpers.icon_text(
      icon: helpers.icon_set.previous_arrow,
  ...
  def next_item
    ...
    text = helpers.icon_text(
      icon: helpers.icon_set.next_arrow,
  ...
  def page_item(item)
    ...
    when :gap
      render PracticalViews::Navigation::Pagination::GotoFormComponent.new(
        pagy: pagy,
