...
class PracticalViews::TiptapDocumentComponent < PracticalViews::BaseComponent
  ...
  class Node < PracticalViews::BaseComponent
    include NodeRendering
  ...
  class Attachment < Node
    ...
    def missing_attachment_figure
      safe_join([
        tag.div {
          render PracticalViews::IconForFileExtensionComponent.new(extension: "missing")
        },
    ...
    def attachment_figure
      if previewable?
        ...
        image = tag.div {
          render PracticalViews::IconForFileExtensionComponent.new(extension: extension)
        }
      end
